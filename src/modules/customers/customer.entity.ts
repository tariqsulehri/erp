 ...
 * (typically account code 1100).  The sum of all customer open balances must
 * always reconcile to the AR control account in the General Ledger.
 *
 * COA linkage:
 *   ar_account_id      → 1100  Accounts Receivable (Control)
...
export class Customer {
  ...
  /* ── COA linkage ──────────────────────────────────────────── */
  @Column('uuid', { nullable: true }) ar_account_id?:      string; // 1100 AR Control
