                      ...
                      return assigned ? (
                        <div style={{ padding: '12px 14px', borderRadius: 9, background: 'rgba(21,128,61,0.07)', border: '1px solid rgba(21,128,61,0.22)', display: 'flex', gap: 12, alignItems: 'center' }}>
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ fontSize: '0.68rem', fontWeight: 700, color: '#15803d', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 3 }}>AR Sub-ledger Account (Auto-assigned)</div>
