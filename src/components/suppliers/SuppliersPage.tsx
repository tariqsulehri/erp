            ...
            <thead>
              <tr>
                {['Code','Name','Type','Terms','Contact','Bank','Status',''].map((h, i) => (
                  <th key={h+i} style={{ padding: '10px 12px', textAlign: i >= 6 ? 'center' : 'left', fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', background: 'var(--color-table-head-bg)', color: 'var(--color-table-head-fg)', borderBottom: '2px solid var(--color-border)', whiteSpace: 'nowrap' }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
